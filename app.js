...
const conn = mongoose.createConnection("mongodb://localhost:27017/QandA",{useNewUrlParser: true});
...
const storage = new GridFsStorage({
    url: "mongodb://localhost:27017/QandA",
    file: (req, file) => {
...
app.get("/questions/profile/:filename",function(req,res){
    gfs.files.findOne({filename: req.user.profilePhoto}, function(err , file){
        if(err){
            console.log(err);
